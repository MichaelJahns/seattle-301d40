...
function displayPics(){
  ...
  // Let is block defined. I went ahead and instead of deleting that console.log i moved it to inside displayPics() and it ran as intended. The problem comes because the const command doesnt add its variables to the window, so any reference to them must be inside the block in which it was defined. 
  console.log(viewed);
