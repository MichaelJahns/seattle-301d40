...
const sumAndProduct = (a, b) => `${a} and ${b}; Sum to ${a + b}, multiply to ${a * b}`
...
// My console calls the command on line 174 as undefined when its ran on page load, but if i comment it out and run it in console it is an object Joe that contains joes relevant demographics. 
// 2. What is "this" when joe.scopeArrow() is invoked?
// this with joe.scopeArrow() is the window object.
// 3. Explain why "this" is different when an arrow function is used.
// 'This' with arrow functions bubbles up, and in the global space it can bubble up into the window. 
